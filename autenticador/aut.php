...
$qrCodeUrl = $Authenticator->getQR('PainelConect', $_SESSION['auth_secret']);
...
<head>
    <meta charset="UTF-8">
    <title>Autenticação baseada em Tempo com o Google Autenticador</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                <h1>Autenticação baseada por tempo</h1>
                <p style="font-style: italic;">Faça autenticação do QRcode no app do Google</p>
                <hr>
                <form action="check.php" method="post">
                    <div style="text-align: center;">
                        <?php if ($_SESSION['failed']): ?>
                            <div class="alert alert-danger" role="alert">
                                        <strong>Ops algo de errado aconteceu!</strong> Digite um código válido.
                            </div>
                            <?php   
                                $_SESSION['failed'] = false;
                            ?>
